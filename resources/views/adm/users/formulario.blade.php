...
@section('css')
    <!-- Jcrop -->
    <link href="adm/css/jcrop/edge1y.css" rel="stylesheet" type="text/css">
    <link href="adm/css/jcrop/edge1u.css" rel="stylesheet" type="text/css">
    <link href="adm/css/jcrop/jcrop.css" rel="stylesheet" type="text/css">
    <!-- /Jcrop -->
                ...
                <div class="x_content">
                    ...
                    <form method="POST" action="{{$action}}" enctype="multipart/form-data" id="demo-form"
                        ...
                        <div class="form-group col-md-2 col-xs-12">
                            ...
                            <select name="id_permissao" class="select2_single form-control">
                                <option {{(isset($ids) ? 'selected="selected"' : "")}} value="">Selecione uma permissão
                                </option>
                                @if (count($permissoes) > 0)
                                    @foreach ($permissoes as $permissao)
                                        <option {{$permissao->id == old('id_permissao') || (old('id_permissao') === null && $permissao->id == $user->id_permissao) ? 'selected="selected"' : ''}}
...
@section('js')
    <!-- Jcrop -->
    <script src="adm/js/jcrop/edge1v.js"></script>
    <script src="adm/js/jcrop/jcrop.js"></script>
    <!-- /Jcrop -->
