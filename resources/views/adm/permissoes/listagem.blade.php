...
<div class="">
    <div class="row conteudoPrincipal">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                        ...
                        @if(count($permissoes) > 0)
                            @foreach($permissoes as $permissao)
                                <tr class="even pointer">
                                    ...
                                    <td><i class="fa fa-search detalhesPermissao" iid="{{$permissao->id}}" style="cursor: pointer"></i></td>
                        ...
                        @else
                            <tr>
                                <td colspan="7" class="iconeListagem">Nenhuma permissão encontrada</td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
            ...
            @foreach($permissoesClasses as $permissao)
                <div class="modal fade" id="detalhesPermissao{{$permissao->id}}" tabindex="-1" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                            aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title">Pagína(s) que podem ser acessada(s)</h4>
                            </div>
                            <div class="modal-body">
                                <table class='table table-striped responsive-utilities jambo_table' id='addTr'>
                                    @foreach($permissao['classes'] as $classe)
                                        <tr>
                                            <td>{{$classe->classe}}</td>
                                        </tr>
                                    @endforeach
