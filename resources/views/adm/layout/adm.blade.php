        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="/home" class="site_title"><img src="adm/images/logoAdm.png"></a>
                </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            @endif
                            @if(isset($itensPermitidos['chamada']))
                                <li><a href="chamadas">
                                        <i class="fa fa-bullhorn"></i>
                                        Chamada <span class="fa "></span></a></li>
                            @endif
                            @if(isset($itensPermitidos['relatorio']))
                                <li><a>
                                    ...
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="relatorios/usuarios">Usuários</a></li>
                                    </ul>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            ...
                            <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                                <li><a href="users/editarPerfil/{{Auth::user()->id}}">Perfil</a>
                                </li>
